...
"Order এবং proposal চাওয়ার ক্ষেত্রে would এর", 
"Possibility এবং uncertainty",
"কোন কিছু করতে চাওয়া",
"Would be",
"Sub + would be + v4 + other words",
"Sub + would have + v3 + other words",
"অনুমান করার ক্ষেত্রেও would এর ব্যবহার",
"Repetition of past habit এর ক্ষেত্রে would",
"Conditioner sentence এ would এর ব্যবহার।",
"প্রাধান্য দেওয়ার ক্ষেত্রে wood এর ব্যবহার",
"Preference বা পছন্দ করার ক্ষেত্রে would",
"Sub + would prefer to + v1",
"Sub + would prefer to + v1 + other words",
"Sub + would like to + v1 + other words.",
"Sub + would like to + v3 + other words.",
"Sub + would hate to + v1 + other words",
"Sub + would love to + v1 + other words",
"Imaginary situation এর ক্ষেত্রে would",
"Would এর passive voice",
"2nd conditional sentence এ would",
"3rd conditional sentence এ would",
"Other uses of would",
];
...
export default function WouldScreen() {
